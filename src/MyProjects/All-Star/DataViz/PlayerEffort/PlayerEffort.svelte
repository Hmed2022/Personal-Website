<script>
	...
	function togglesumFTA() {
    sumFTA = !sumFTA;
    }
	function togglesumORB() {
    sumORB = !sumORB;
    }
	function togglesumPF() {
    sumPF = !sumPF;
    }
	function togglesumStocks() {
    sumStocks = !sumStocks;
    }
...
<section>
	<p>
	 ...
	 <p class= "hover">
		(Hover over the highlighted titles to visualize them separately)
	 </p>
<p>
  ...
  <div class="chart">
		 <Graph {data} {show} {sumFTA} {sumORB} {sumPF} {sumStocks}/>
  </div>
