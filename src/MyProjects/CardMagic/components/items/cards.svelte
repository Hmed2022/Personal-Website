<script>
  ...
  function getCardSrc(card) {
    ...
    return `/assets/CardMagic/Cards_png/${fileSuit[card.suit]}-${card.value < 10 ? "0" : ""}${card.value}.png`;
  }
...
<audio src="/assets/CardMagic/flipcard.wav" bind:this={audioEl} />
<audio src="/assets/CardMagic/takingcard.mp3" bind:this={takeCardEl} preload="auto" />
  ...
  {#each cards as card, i}
    {#if !showSelectedCard || card === selectedCard}
      <div
        ...
        on:mouseenter={playTakeCardSound}
