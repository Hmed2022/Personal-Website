<script>
  ...
  export let title = "Press the ‘Down key’ to see the Math!";
...
<style>
  ...
  .container { width:21vw; max-width:140px; display:flex; flex-direction:column; justify-content:center; align-items:center; user-select:none; }
