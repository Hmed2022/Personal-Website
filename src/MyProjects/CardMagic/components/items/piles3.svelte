<script>
  ...
  import { arrayCards, currentCard , cycle2array, assembly3, resetKey } from '../../stores/misc.js';
...
<audio src="/assets/CardMagic/error.mp3" bind:this={errorAudio} preload="auto" />
